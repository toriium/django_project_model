...
MIDDLEWARE = [
    ...
    # "whitenoise.middleware.WhiteNoiseMiddleware",  # Whitenoise middleware to serve static files
    ...
    "library_app.middleware.RestrictNonAuthorizedUserMiddleware",  # Restricts non authorized users
